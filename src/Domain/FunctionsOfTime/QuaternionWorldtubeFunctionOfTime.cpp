...
QuaternionWorldtubeFunctionOfTime<
    MaxDeriv>::QuaternionWorldtubeFunctionOfTime() = default;

template <size_t MaxDeriv>
QuaternionWorldtubeFunctionOfTime<MaxDeriv>::QuaternionWorldtubeFunctionOfTime(
    QuaternionWorldtubeFunctionOfTime&&) = default;

template <size_t MaxDeriv>
QuaternionWorldtubeFunctionOfTime<MaxDeriv>::QuaternionWorldtubeFunctionOfTime(
    const QuaternionWorldtubeFunctionOfTime&) = default;

template <size_t MaxDeriv>
auto QuaternionWorldtubeFunctionOfTime<MaxDeriv>::operator=(
    QuaternionWorldtubeFunctionOfTime&&)
    -> QuaternionWorldtubeFunctionOfTime& = default;

template <size_t MaxDeriv>
auto QuaternionWorldtubeFunctionOfTime<MaxDeriv>::operator=(
    const QuaternionWorldtubeFunctionOfTime&)
    -> QuaternionWorldtubeFunctionOfTime& = default;
...
QuaternionWorldtubeFunctionOfTime<MaxDeriv>::get_clone() const {
  return std::make_unique<QuaternionWorldtubeFunctionOfTime>(*this);
}

template <size_t MaxDeriv>
std::unique_ptr<FunctionOfTime>
QuaternionWorldtubeFunctionOfTime<MaxDeriv>::create_at_time(
    const double t, const double expiration_time) const {
  return std::make_unique<QuaternionWorldtubeFunctionOfTime>(
      t, func(t), angle_f_of_t_.func_and_derivs(t), expiration_time);
}

template <size_t MaxDeriv>
std::array<double, 2> QuaternionWorldtubeFunctionOfTime<MaxDeriv>::time_bounds()
    const {
...
template <size_t MaxDeriv>
double QuaternionWorldtubeFunctionOfTime<MaxDeriv>::expiration_after(
    const double time) const {
  return stored_quaternions_and_times_.expiration_after(time);
}

template <size_t MaxDeriv>
void QuaternionWorldtubeFunctionOfTime<MaxDeriv>::pup(PUP::er& p) {
...
template <size_t MaxDeriv>
void QuaternionWorldtubeFunctionOfTime<MaxDeriv>::unpack_old_version(
...
template <size_t MaxDeriv>
void QuaternionWorldtubeFunctionOfTime<MaxDeriv>::update(
...
template <size_t MaxDeriv>
void QuaternionWorldtubeFunctionOfTime<MaxDeriv>::solve_quaternion_ode(
  ...
  const auto quaternion_ode_system =
      [this, &factor](const boost::math::quaternion<double>& state,
        ...
        // We are defining the quaternion ODE in inertial frame in the WT file
        dt_state = factor * 0.5 * omega * state;
      };
...
QuaternionWorldtubeFunctionOfTime<MaxDeriv>::setup_func(const double t) const {
...
QuaternionWorldtubeFunctionOfTime<MaxDeriv>::quat_func(const double t) const {
  return std::array<DataVector, 1>{quaternion_to_datavector(setup_func(t))};
}

template <size_t MaxDeriv>
std::array<DataVector, 2>
QuaternionWorldtubeFunctionOfTime<MaxDeriv>::quat_func_and_deriv(
  ...
  boost::math::quaternion<double> dtquat = 0.5 * omega * quat;
...
QuaternionWorldtubeFunctionOfTime<MaxDeriv>::quat_func_and_2_derivs(
    const double t) const {
  boost::math::quaternion<double> quat = setup_func(t);
...
QuaternionWorldtubeFunctionOfTime<MaxDeriv>::quat_func_and_3_derivs(
    const double t) const {
  boost::math::quaternion<double> quat = setup_func(t);
  ...
  boost::math::quaternion<double> dtquat = 0.5 * omega * quat;
  boost::math::quaternion<double> dt2quat =
      0.5 * (dtomega * quat + omega * dtquat);
  boost::math::quaternion<double> dt3quat =
      0.5 * (dt2omega * quat + 2.0 * dtomega * dtquat + omega * dt2quat);
...
template <size_t MaxDeriv>
bool operator==(const QuaternionWorldtubeFunctionOfTime<MaxDeriv>& lhs,
                const QuaternionWorldtubeFunctionOfTime<MaxDeriv>& rhs) {
...
std::ostream& operator<<(
    std::ostream& os,
    const QuaternionWorldtubeFunctionOfTime<MaxDeriv>& quaternion_f_of_t) {
...
#define INSTANTIATE(_, data)                                            \
  template class QuaternionWorldtubeFunctionOfTime<DIM(data)>;          \
  template bool operator==                                              \
      <DIM(data)>(const QuaternionWorldtubeFunctionOfTime<DIM(data)>&,  \
                  const QuaternionWorldtubeFunctionOfTime<DIM(data)>&); \
  template bool operator!=                                              \
      <DIM(data)>(const QuaternionWorldtubeFunctionOfTime<DIM(data)>&,  \
                  const QuaternionWorldtubeFunctionOfTime<DIM(data)>&); \
