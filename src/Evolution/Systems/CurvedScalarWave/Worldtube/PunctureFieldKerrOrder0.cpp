...
void puncture_field_acc_0(
  ...
  dv_13 =
      d_33 * dv_12 + d_37 * dv_8 + d_39 * dv_9 + dv_10 + dv_11 + dv_8 + dv_9;
  DataVector& dv_14 = temps.at(14);
  dv_14 = -d_28 * (Dy + d_14 * dv_0 + dv_2) +
          d_29 * (d_14 * dv_3 + d_14 * dv_4 + dv_7) + dv_13;
  ...
  dv_25 = -4 * d_1 * dv_16 * dv_24 * zp + d_33 * dv_23 + d_37 * dv_20 +
          d_39 * dv_21 + dv_20 + dv_21 + dv_22;
  ...
  dv_34 = Dx * d_10 * d_36 * d_6 - 2 * Dy * M * d_17 * d_22 * d_35 * d_38 - Dy +
          d_11 * dv_11 + dv_32 * (d_25 * d_38 * d_71 - d_28 * d_44 + ypdot);
  ...
  get(get<CurvedScalarWave::Tags::Psi>(*result)) = pow(dv_26, -1.0 / 2.0);
  get(get<::Tags::dt<CurvedScalarWave::Tags::Psi>>(*result)) =
      1.0 / dv_26 *
      (-Dx * d_29 * (Dz * d_50 * d_67 - dv_31) + Dx * d_66 * dv_27 -
       d_30 * d_50 * dv_22 + d_34 * d_55 * dv_20 + d_38 * d_55 * dv_21 +
       d_53 * dv_23 + d_60 * d_62 * dv_20 - d_60 * d_63 * dv_21 +
       d_65 * dv_18 * dv_27 + dv_11 * dv_31 -
       1.0 / 2.0 * dv_15 *
           (d_1 * d_46 * d_52 * d_84 *
                (d_88 * d_89 + d_88 * xp * xpdot +
                 d_94 * (3 * d_21 * d_85 * d_90 -
                         d_92 * (d_0 * d_83 * d_86 + d_17 * d_91))) +
            d_25 * d_45 *
                (d_13 * zpdot *
                     (-d_14 * d_89 * d_95 - d_14 * d_96 * xpdot +
                      zpdot * (-d_13 * d_19 * d_93 * d_97 + 2)) +
                 d_14 * d_78 + d_43 * d_77 +
                 d_69 * (d_98 * (-d_32 * d_4 + xp * (d_0 - d_1)) +
                         xpdot * (-d_100 * d_5 + d_2 * (d_32 + d_79 * d_95)) +
                         ypdot * (-d_100 * d_9 + d_2 * (d_101 + d_96 * yp))) +
                 d_7 * d_76 +
                 d_71 *
                     (d_98 * (d_0 * yp - d_1 * yp + d_101 * d_5) +
                      xpdot * (d_10 * d_5 * d_99 +
                               d_2 * (-d_101 + d_84 * d_85 * d_86 * xp * yp)) +
                      ypdot *
                          (d_2 * (d_32 + d_80 * d_95) - d_42 * d_9 * d_99))) +
            d_76 * xpdot + d_77 * ypdot + d_78 * zpdot) *
           1.0 / (d_47 * d_47) +
       dv_16 * dv_29 - dv_16 * dv_30 +
       dv_32 * (d_19 * d_33 * dv_37 -
                d_24 * d_74 *
                    (d_13 * d_50 * dv_38 + zp * (Dy * zpddot + Dz * ypddot)) -
                d_25 * d_58 * dv_39 +
                d_29 * (Dx * d_50 * d_67 * zpdot + Dz * d_50 * d_67 * xpdot -
                        d_11 * (Dx * ypddot + Dy * xpddot) +
                        d_13 * zp * (Dx * zpddot + Dz * xpddot) - d_58 * dv_5 -
                        d_58 * dv_6) -
                d_34 * d_73 * dv_8 + d_37 * dv_35 - d_38 * d_73 * dv_9 +
                d_39 * dv_36 + d_50 * d_72 * dv_10 - d_62 * d_75 * dv_8 +
                d_63 * d_75 * dv_9 + d_64 * d_74 * dv_39 - d_64 * dv_12 -
                d_65 * d_7 * dv_40 - d_66 * dv_40 + dv_29 - dv_30 + dv_35 +
                dv_36 + dv_37) -
       dv_34 * ypdot + xpdot * (d_29 * dv_27 - d_70 * dv_32 + dv_33) +
       zpdot *
           (Dz + d_19 * dv_28 - d_31 * dv_16 + d_31 * dv_18 - d_68 * dv_32)) /
  ...
  get<1>(get<::Tags::deriv<CurvedScalarWave::Tags::Psi, tmpl::size_t<3>,
                           Frame::Inertial>>(*result)) = dv_34 * dv_41;
  get<2>(get<::Tags::deriv<CurvedScalarWave::Tags::Psi, tmpl::size_t<3>,
                           Frame::Inertial>>(*result)) =
      -dv_41 * (Dz - d_102 * dv_16 + d_102 * dv_18 + d_19 * d_92 * dv_24 -
                d_27 * d_68 *
                    (-d_28 * (Dy * d_15 + dv_2) +
                     d_29 * (Dx * d_16 - dv_17 * xpdot) + dv_13));
}
}  // namespace CurvedScalarWave::Worldtube
